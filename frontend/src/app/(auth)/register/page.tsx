            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full h-11 pl-10 pr-4 border-2 border-gray-300 rounded-md bg-transparent text-foreground"
                  required
                >
                  <option value="" className="bg-white text-black dark:bg-slate-900 dark:text-white">
                    Select your role
                  </option>
                  <option value="jobseeker" className="bg-white text-black dark:bg-slate-900 dark:text-white">
                    Find a Job
                  </option>
                  <option value="recruiter" className="bg-white text-black dark:bg-slate-900 dark:text-white">
                    Hire Talent
                  </option>
                </select>
              </div>
