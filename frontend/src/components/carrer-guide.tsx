...
const CarrerGuide = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("open-career-guide", handleOpenRequest);
    return () => window.removeEventListener("open-career-guide", handleOpenRequest);
  }, []);
    ...
    <div className="max-w-7xl mx-auto px-4 py-16 bg-secondary/30">
      <div className="text-center mb-12">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto border-2 border-blue-200 dark:border-blue-500/30 shadow-[0_0_70px_-15px_rgba(37,99,235,0.45)]">
            {!response ? (
              <>
                ...
                <div className="space-y-4 py-4">
                  <div className="border-2 border-dashed border-blue-300 dark:border-blue-500/40 rounded-xl p-8 bg-blue-50/40 dark:bg-blue-950/20">
