    ...
    <nav className="z-50 sticky top-0 bg-background/80 border-b backdrop-blur-md shadow-sm">
        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <Link href={"/"} className="flex items-center gap-2 group">
              <div className="h-9 w-9 rounded-lg bg-gradient-to-br from-blue-600 to-indigo-500 flex items-center justify-center shadow-sm transition-transform duration-300 group-hover:scale-105">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            {/* <Link href={"/about"}>
              <Button
                ...
                className="flex items-center gap-2 font-medium"
              >
                <Sparkles size={16} /> Career Guidance
              </Button>
            </Link> */}
      ...
      >
        <div className="px-3 py-3 space-y-1 bg-background/95 backdrop-blur-md">
          ...
          <Link href={"/resume-analyzer"} onClick={toggleMenu}>
            <Button
              variant={"ghost"}
              className="w-full justify-start gap-3 h-11"
            >
          ...
          <Link href={"/career-guide"} onClick={toggleMenu}>
            <Button
              variant={"ghost"}
              className="w-full justify-start gap-3 h-11"
            >
              <Sparkles size={18} /> Career Guidance
            </Button>
          </Link>
