...
const ResumeAnalyzer = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("open-resume-analyzer", handleOpenRequest);
    return () => window.removeEventListener("open-resume-analyzer", handleOpenRequest);
  }, []);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-16 bg-secondary/30">
      <div className="text-center mb-12">
        <div
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full border bg-blue-50 dark:bg-blue-950/30 mb-4"
        >
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto border-2 border-blue-200 dark:border-blue-500/30 shadow-[0_0_70px_-15px_rgba(37,99,235,0.45)]">
            {!response ? (
              <>
                <DialogHeader className="text-center sm:text-center">
                  <DialogTitle className="text-3xl font-extrabold brand-gradient-text">
                    AI Resume Analyzer
                  </DialogTitle>
                ...
                <div className="space-y-4 py-4">
                  <div
                    ...
                    className="border-2 border-dashed border-blue-300 dark:border-blue-500/40 rounded-xl p-10 text-center cursor-pointer bg-blue-50/40 dark:bg-blue-950/20 hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-950/30 transition-colors"
                  >
                    <div className="flex flex-col items-center gap-4">
                      <div className="h-16 w-16 rounded-xl bg-background shadow-md flex items-center justify-center">
                      ...
                      <Button
                        ...
                        className="bg-gradient-to-r from-blue-600 to-indigo-500 hover:from-blue-700 hover:to-indigo-600 text-white h-11 px-8 gap-2"
                      >
                        <FileText size={16} />
                        Choose PDF File
                      </Button>
                  ...
                  <Button
                    ...
                    className="w-full h-11 gap-2 bg-gradient-to-r from-blue-600 to-indigo-500 hover:from-blue-700 hover:to-indigo-600 text-white"
                  >
                    {loading ? (
                      <>
